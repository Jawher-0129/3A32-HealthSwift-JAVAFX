...
import com.exemple.pidevd.Controller.MainController; // Import the MainController if it's in a different package
import com.exemple.pidevd.Controller.SidebarController;
